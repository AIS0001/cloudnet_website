      ...
      <section className="py-20 bg-gradient-to-br from-orange-50 to-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            {/* WhatsApp Section */}
            <ScrollReveal direction="left" className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <ScrollReveal direction="right" className="bg-white rounded-2xl shadow-lg p-8 text-center">
              <div className="mb-6">
