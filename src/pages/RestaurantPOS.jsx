  ...
  const pricingPackages = [
    {
      ...
      downloadName: 'chefmate-basic-plan.jpg',
      features: [
        'One Cashier account',
        'One Manager Account',
        'Basic Sale Report - Bill Wise',
        'Up to 20 table accessible',
    ...
    },
    {
      id: 'premium',
      title: 'Premium',
      subtitle: 'For Established Business',
      price: '฿1000',
      period: '/month',
      billed: 'Billed Annually',
      icon: <Crown size={42} />,
      downloadName: 'chefmate-premium-plan.jpg',
      features: [
    ...
    },
    {
      id: 'enterprise',
      title: 'Enterprise',
      subtitle: 'For Large Scale Operation',
      price: '฿1500',
      period: '/month',
      billed: 'Billed Annually',
      icon: <Building2 size={42} />,
      downloadName: 'chefmate-enterprise-plan.jpg',
      features: [
        ...
        'KDS system for order queue display'
      ]
    }
  ]
